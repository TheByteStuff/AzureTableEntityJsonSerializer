...
namespace AzureTableEntityJsonSerializerXUnitTest
{
    public class AzureTableEntityJsonConverterXUnitTest
    {
        ...
        public void TestPartitionKeyField()
        {
            ...
            TableEntity dte2 = serializer.Deserialize(ComplexEntity);
        ...
        public void TestETagField()
        {
            AzureTableEntityJsonSerializer serializer = new AzureTableEntityJsonSerializer();
            TableEntity dte2 = serializer.Deserialize(ComplexEntity);
            Azure.ETag etag = new Azure.ETag("EtagValue");
            Assert.Equal(etag, dte2.ETag);
        }
        ...
        public void TestTimestampField()
        {
            AzureTableEntityJsonSerializer serializer = new AzureTableEntityJsonSerializer();
            TableEntity dte2 = serializer.Deserialize(ComplexEntity);
            Assert.Equal(DateTimeOffset.Parse(TimestampValueRaw).UtcDateTime, dte2.Timestamp);
        }
        ...
        public void TestPropertiesEdmTypeDateTime()
        {
            AzureTableEntityJsonSerializer serializer = new AzureTableEntityJsonSerializer();
            TableEntity dte2 = serializer.Deserialize(ComplexEntity);
            Assert.Equal(DateTimeOffset.Parse(DateTimeValueRaw).UtcDateTime, dte2.GetDateTimeOffset("DateTimeField"));
        }
        ...
        public void TestPropertieEdmTypeBinary()
        {
            AzureTableEntityJsonSerializer serializer = new AzureTableEntityJsonSerializer();
            TableEntity dte2 = serializer.Deserialize(ComplexEntity);
            Assert.Equal(BinaryValue, dte2.GetBinary("BinaryField"));
        }
        ...
        public void TestPropertiesEdmTypeBoolean()
        {
            AzureTableEntityJsonSerializer serializer = new AzureTableEntityJsonSerializer();
            TableEntity dte2 = serializer.Deserialize(ComplexEntity);
            Assert.Equal(BooleanValue, dte2.GetBoolean("BooleanField"));
        }
        ...
        public void TestPropertiesEdmTypeDouble()
        {
            AzureTableEntityJsonSerializer serializer = new AzureTableEntityJsonSerializer();
            TableEntity dte2 = serializer.Deserialize(ComplexEntity);
            Assert.Equal(DoubleValue, dte2.GetDouble("DoubleField"));
        }
        ...
        public void TestPropertiesEdmTypeGuid()
        {
            AzureTableEntityJsonSerializer serializer = new AzureTableEntityJsonSerializer();
            TableEntity dte2 = serializer.Deserialize(ComplexEntity);
            Assert.Equal(GuidValue, dte2.GetGuid("GUIDField"));
        }
        ...
        public void TestPropertiesEdmTypeInt32()
        {
            AzureTableEntityJsonSerializer serializer = new AzureTableEntityJsonSerializer();
            TableEntity dte2 = serializer.Deserialize(ComplexEntity);
            Assert.Equal(Int32Value, dte2.GetInt32("Int32Field"));
        }
        ...
        public void TestPropertiesEdmTypeInt64()
        {
            AzureTableEntityJsonSerializer serializer = new AzureTableEntityJsonSerializer();
            TableEntity dte2 = serializer.Deserialize(ComplexEntity);
            Assert.Equal(Int64Value, dte2.GetInt64("Int64Field"));
        }
        ...
        public void TestPropertiesEdmTypeString()
        {
            AzureTableEntityJsonSerializer serializer = new AzureTableEntityJsonSerializer();
            TableEntity dte2 = serializer.Deserialize(ComplexEntity);
            Assert.Equal(StringValue, dte2.GetString("StringField"));
        }
